...
function useContextValue(): ContextValue {
  ...
  const initailColor = isMobile() ? mobileColor : pcColor
  const [color, setColorState] = useState<Color>(initailColor)

  // Function to get the window width or a default value if the window is not available
