...
function LogoThemedImage({ logo, alt, imageClassName }) {
  ...
  const darkLogo = logo.srcDark || logo.src

  const sources = {
    light: useBaseUrl(color === 'light' ? lightLogo : darkLogo),
    dark: useBaseUrl(color === 'light' ? lightLogo : darkLogo)
  }
  const themedImage = (
    <ThemedImage
